                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <ul class="nav nav-pills justify-content-end mb-0" id="chart-tab-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="btn btn-outline-dark me-1" id="refresh_table_zone" type="button" title="Refresh Table">
                                    <i class="ti ti-refresh"></i>
                                </button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="btn btn-outline-primary" id="create_zone" type="button" data-bs-toggle="modal" data-bs-target="#modalZone" title="Create Zone">
                    ...
                    <div class="card tbl-card">
                        <div class="card-body">
                            <ul class="nav nav-tabs mb-3" id="zoneTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="special-zone" data-bs-toggle="tab" data-bs-target="#tab-special-zone" type="button" role="tab" aria-controls="tab-special-zone" aria-selected="true">
                                        Special Economic Zone
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="zone" data-bs-toggle="tab" data-bs-target="#tab-zone" type="button" role="tab" aria-controls="tab-zone" aria-selected="false">
                                        Zone
                                    </button>
                                </li>
                            </ul>
                            <div class="tab-content border border-top-0 p-3">
                                <div class="tab-pane fade show active" id="tab-special-zone" role="tabpanel" aria-labelledby="special-zone">
