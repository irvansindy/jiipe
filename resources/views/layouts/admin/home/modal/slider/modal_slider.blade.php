                                ...
                                @foreach ($locales as $locale => $properties)
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link {{ $loop->first ? 'active' : '' }}"
                                            id="slider-{{ $locale }}-tab"
                                            data-bs-toggle="tab"
                                            data-bs-target="#slider-{{ $locale }}"
                                            type="button"
                                            role="tab"
                                ...
                                @foreach ($locales as $locale => $properties)
                                    <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control slider_description"
                                                      id="slider_description_{{ $locale }}"
                            ...
                            <div class="mt-4">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="is_active">
                                        ...
                                        <small class="text-muted d-block">Enable this slider to show on homepage</small>
                                    </label>
                                </div>
                            </div>
                        </div>
