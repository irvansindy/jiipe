...
@section('content')
    <div class="pc-container">
        <div class="pc-content">
            ...
            <div class="row">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <ul class="nav nav-pills justify-content-end mb-0" id="chart-tab-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="btn btn-outline-dark me-1" id="refresh_table_users" type="button"
                                    title="Refresh Table">
                ...
                <div class="col-md-12 col-lg-6 col-xl-6 col-sm-12">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <ul class="nav nav-pills justify-content-end mb-0" id="chart-tab-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="btn btn-outline-dark me-1" id="refresh_table_roles" type="button"
                                    title="Refresh Table">
                                    <i class="ti ti-refresh"></i>
                                </button>
                            </li>
            ...
            @include('layouts.admin.users.modal_role_permissions')
        </div>
    </div>
@endsection()
@push('css')
