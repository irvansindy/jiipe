        ...
        <div class="pc-content">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-2 f-w-400 text-muted">Total Contact (Email)</h6>
                            ...
                            <p class="mb-0 text-muted text-sm">
                                Increase <span class="text-primary">35.000</span>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-0 text-muted text-sm">
                                Increase <span class="text-danger">$20,395</span>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-0 text-muted text-sm">
                                Increase <span class="text-success">8,900</span>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="mb-0 text-muted text-sm">
                                Increase <span class="text-warning">1,943</span>
                            </p>
                        </div>
                    </div>
                </div>
