                            ...
                            <div class="d-flex align-items-center justify-content-between mb-3">
                                <div class="row">
                                    <div class="col-xl-3 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Reason for considering
                                                JIIPE</label>
                                            <select class="form-control" id="filter_status_appointment"
                                                name="filter_status_appointment">
                                    ...
                                    <div class="col-xl-3 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Total Required Power</label>
                                            <select class="form-control" id="filter_status_appointment"
                                                name="filter_status_appointment">
                                                <option value="">-- Select One --</option>
                                    ...
                                    <div class="col-xl-3 col-md-6 col-sm-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Total Required Natural
                                                Gas
                                            </label>
                                            <select class="form-control" id="filter_status_appointment"
                                                name="filter_status_appointment">
                                                <option value="">-- Select One --</option>
                                                <option value="Below 100  MMBTU / annum">Below 100  MMBTU / annum</option>
                                                <option value="Above 100  MMBTU / annum">Above 100  MMBTU / annum</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-md-3 col-sm-12">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label">Est. Vol. Throughput
                                                Via Seaport</label>
                                            <select class="form-control" id="filter_status_appointment"
                                                name="filter_status_appointment">
                                                <option value="">-- Select One --</option>
                    ...
                    <div class="card tbl-card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover table-borderless mb-0" id="table_list_appointment" width="100%">
                                    <thead>
                                        <tr>
                                            <th>FULL NAME</th>
                                            <th>COMPANY NAME</th>
