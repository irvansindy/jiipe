                        ...
                        <div class="card-body">
                            <ul class="nav nav-tabs mb-3" id="zoneTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="news-articles" data-bs-toggle="tab" data-bs-target="#tab-news-articles" type="button" role="tab" aria-controls="tab-news-articles" aria-selected="true">
                                        News & Articles
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="news-categories" data-bs-toggle="tab" data-bs-target="#tab-news-categories" type="button" role="tab" aria-controls="tab-news-categories" aria-selected="false">
                                        Categories
                                    </button>
                                </li>
                            </ul>
                            <div class="tab-content border border-top-0 p-3">
                                <div class="tab-pane fade show active" id="tab-news-articles" role="tabpanel" aria-labelledby="news-articles">
                                ...
                                <div class="tab-pane fade" id="tab-news-categories" role="tabpanel" aria-labelledby="news-categories">
                                    <ul class="nav nav-pills justify-content-end mb-2" id="chart-tab-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="btn btn-outline-dark me-1" id="refresh_table_news_categories" type="button"
                                                title="Refresh Table">
                                                <i class="ti ti-refresh"></i>
                                            </button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="btn btn-outline-primary" id="create_news_categories" type="button"
                                                data-bs-toggle="modal" data-bs-target="#modalNewsCategories" title="Create Menu">
                                                <i class="ti ti-pencil"></i>
                                            </button>
                                        </li>
                                    </ul>
