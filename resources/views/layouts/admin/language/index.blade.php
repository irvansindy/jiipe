                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-danger d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <button type="button" class="btn btn-light btn-sm me-2" id="sync_config_btn"
                                    title="Sync from Config">
                                    <i class="ti ti-refresh"></i> Sync Config
                                </button>
                                <button type="button" class="btn btn-light btn-sm me-2" id="refresh_table_language"
                                    title="Refresh Table">
                                    <i class="ti ti-refresh"></i>
                                </button>
                                <button type="button" class="btn btn-light btn-sm" id="create_language"
                                    data-bs-toggle="modal" data-bs-target="#ModalLanguage">
