                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <div class="page-header-title">
                                <h5 class="m-b-10 text-danger">Brochure</h5>
                            </div>
                            <br>
                            <ul class="breadcrumb">
                ...
                <div class="col-md-12 col-xl-12 col-sm-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            ...
                            <button class="btn btn-primary" id="create_brochure" type="button" title="Create Brochure"
                                data-bs-toggle="modal" data-bs-target="#modalBrochure">
                                        ...
                                        <div class="card h-100">
                                            ...
                                            <div class="position-relative" style="height: 200px; overflow: hidden;">
                                                <img src="{{ $brochure->image && $brochure->image !== 'default.jpg' ? asset('uploads/brochures/images/' . $brochure->image) : 'https://via.placeholder.com/300x200?text=No+Image' }}"
                                                    class="card-img-top"
                                                    alt="{{ $brochure->translations->first()->title ?? 'No Title' }}"
                                                    style="width: 100%; height: 100%; object-fit: cover;" loading="lazy">

                                                {{-- Status Badge --}}
                                                <span
                                                    class="position-absolute top-0 end-0 m-2 badge {{ $brochure->is_active ? 'bg-success' : 'bg-secondary' }}">
                                            ...
                                            <div class="card-body">
                                                <h6 class="card-title text-truncate"
                                                    title="{{ $brochure->translations->first()->title ?? 'No Title' }}">
