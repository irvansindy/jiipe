...
@section('content')
    ...
    <section id="cover-karir">
        ...
        <div class="karir-images"
            style="background-image: url('{{ $careerHeader && $careerHeader->image ? asset('uploads/career/header/' . $careerHeader->image) : asset('uploads/career/header/header_career.jpg') }}') !important;">
            <div class="prelative container">
            </div>
        </div>
    </section>
    ...
    <section class="karir-sec-1">
        <div class="prelative container">
            <div class="row">
                <div class="col-md-15">
                    <img src="{{ asset('asset/images/beijing-red.png') }}" alt="career icon" decoding="async"
                        loading="lazy">
                    <p class="info">
                        {{ __('Job Vacancies') }}
                    </p>
                ...
                <div class="col-md-45">
                            ...
                            <div class="sortir float-md-right">
                                <form class="form-inline" method="GET">
                                    <div class="form-group">
                                        ...
                                        <select name="sort" id="inputState" class="form-control"
                                            onchange="this.form.submit()">
                                            <option value="date" {{ $sort == 'date' ? 'selected' : '' }}>
                                                {{ __('Date') }}</option>
                                            <option value="education" {{ $sort == 'education' ? 'selected' : '' }}>
                                                {{ __('Education') }}</option>
                                            <option value="experience" {{ $sort == 'experience' ? 'selected' : '' }}>
                                                {{ __('Experience') }}</option>
                                        </select>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="blocks_list_careers">
                        @forelse($careers as $career)
                            <div class="items">
                                <div class="title-loker" style="line-height: 1.4;">
                                    <p style="line-height: 1.4; margin: 0;">{{ $career->position }}</p>
                                </div>
                                <div class="row lowongan-content">
                                    ...
                                    <div class="col-md-30">
                                        <div class="min-pend">
                                            ...
                                            <p class="content">{{ $career->education ? $career->education->name : '-' }}
                                            </p>
                                        </div>
                                        <div class="min-peng">
                                        ...
                                        <div class="lebih">
                                            <a href="{{ route('client.career.detail', $career->id) }}" class="toscroll">
                                                <p>{{ __('Apply for this position') }} <span><img
                                                            src="{{ asset('asset/images/arrow-red.png') }}"
                                                            alt="arrow"></span></p>
                                            </a>
                                        </div>
                                    </div>
