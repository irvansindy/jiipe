...
@section('content')
    ...
    <section class="cover-profil cover-contact lazy-bg"
        style="background-image: url('{{ asset('asset/images/static/3ec59cba31JIIPE Tower up.jpg') }}');">
        <div class="prelative container">
            <div class="row"></div>
        </div>
    </section>
            ...
            <div class="row utama">
                ...
                <div class="col-md-45">
                    <div class="judul mb-4 pb-4">
                        ...
                        <h5>Please contact our hotline for further information (Monday - Friday, 08.00 - 17.00 local time)
                        </h5>
                                    ...
                                    <div class="sn_text d-inline-block align-top pl-1">
                                        ...
                                        <p class="pt-1">
                                            ...
                                            <a class="clicks_map" target="_blank"
                                                href="https://www.google.com/maps/place/JIIPE+Office/@-7.0856958,112.6046212,17z/data=!4m5!3m4!1s0x0:0xaee7dea2e8cb80a3!8m2!3d-7.0862954!4d112.6030116">Look
                                                on Google Map</a>
                                        </p>
                                    </div>
                                </div>
