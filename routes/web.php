...
// 🔹 Fortify routes dengan prefix admin/home/
Route::group(['prefix' => 'admin/home/', 'middleware' => config('fortify.middleware', ['web'])], function () {
    // login
    Route::get('index', [AuthenticatedSessionController::class, 'create'])
        ->middleware(['guest'])
        ->name('index');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('admin/menu-permission')->group(function () {
     ...
     */
    Route::prefix('admin/zone-clusters')->group(function () {
     ...
     */
    Route::prefix('admin/sub-developments')->group(function () {
     ...
     */
    Route::prefix('admin/regional-advantages')->group(function () {
     ...
     */
    Route::prefix('admin/resource-energies')->group(function () {
    ...
    */
    ...
    Route::prefix('admin/brochure')->group(function () {
        // Index page
