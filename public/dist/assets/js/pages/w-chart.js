    ...
    (function () {
        var options = {
            ...
            series: [
                {
                    data: [
                        220, 230, 240, 220, 225, 215, 205, 195, 185, 150, 185, 195, 80, 205, 215,
                        225, 240, 225, 215, 205, 80, 215, 225, 240, 215, 210, 190,
                    ],
                },
            ],
    ...
    (function () {
        var options = {
            ...
            series: [
                {
                    data: [
                        1800, 1500, 1800, 1700, 1400, 1200, 1000, 800, 600, 500, 600, 800, 500, 700,
                        400, 600, 500, 600,
                    ],
                },
            ],
    ...
    (function () {
        var options = {
            ...
            series: [
                {
                    data: [
                        100, 140, 100, 240, 115, 125, 90, 100, 80, 150, 160, 150, 170, 155, 150,
                        160, 145, 200, 140, 160,
                    ],
                },
            ],
